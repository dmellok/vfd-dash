...
/* RAV4 */
/* RAV4 1 */
void u8g2_Setup_futaba_vfd_rav4_253x63_1(u8g2_t *u8g2, const u8g2_cb_t *rotation, u8x8_msg_cb byte_cb, u8x8_msg_cb gpio_and_delay_cb)
{
  uint8_t tile_buf_height;
  uint8_t *buf;
  u8g2_SetupDisplay(u8g2, u8x8_d_futaba_vfd_rav4_253x63, u8x8_cad_empty, byte_cb, gpio_and_delay_cb);
  buf = u8g2_m_32_8_1(&tile_buf_height);
  u8g2_SetupBuffer(u8g2, buf, tile_buf_height, u8g2_ll_hvline_vertical_top_lsb, rotation);
}
/* RAV4 2 */
void u8g2_Setup_futaba_vfd_rav4_253x63_2(u8g2_t *u8g2, const u8g2_cb_t *rotation, u8x8_msg_cb byte_cb, u8x8_msg_cb gpio_and_delay_cb)
{
  uint8_t tile_buf_height;
  uint8_t *buf;
  u8g2_SetupDisplay(u8g2, u8x8_d_futaba_vfd_rav4_253x63, u8x8_cad_empty, byte_cb, gpio_and_delay_cb);
...
/* RAV4 f */
void u8g2_Setup_futaba_vfd_rav4_253x63_f(u8g2_t *u8g2, const u8g2_cb_t *rotation, u8x8_msg_cb byte_cb, u8x8_msg_cb gpio_and_delay_cb)
{
  uint8_t tile_buf_height;
  uint8_t *buf;
  u8g2_SetupDisplay(u8g2, u8x8_d_futaba_vfd_rav4_253x63, u8x8_cad_empty, byte_cb, gpio_and_delay_cb);
